...
<div class="container">
    <div class="page-header">
        <h1>Ejemplo Básico de DataTables</h1>
    </div>
    <p class="lead">Uso de las propiedades basicas para el uso de la libreria DataTables.</p>
    <p>
...
<footer class="footer">
    <div class="container">
        <p class="text-muted">Diego Ojeda.</p>
    </div>
</footer>
...
<script type="text/javascript" src="node_modules/datatables.net-buttons-bs/js/buttons.bootstrap.min.js"></script>
